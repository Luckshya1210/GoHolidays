    ...
    <div className='grid grid-cols-1 xl:grid-cols-[2fr_3fr] border border-slate-300 rounded-lg p-8 gap-8 '>
        ...
        <div className='grid grid-rows-[1fr_2fr_1fr]  ' >
            <div>
                ...
                <Link to={`/detail/${hotel._id}`} className='font-bold text-2xl cursor-pointer'>{hotel.name}</Link>
            </div>
            <div>
            ...
            <div className='grid grid-cols-2 items-end whitespace-nowrap'>
                ...
                <div className='flex flex-col items-end gap-1'>
                    ...
                    <Link to={`/detail/${hotel._id}`} className='bg-blue-600 text-white h-full max-w-fit rounded-sm  p-2 font-bold text-xl hover:bg-blue-800'>View More</Link>
                </div>
            </div>
